...
def predict():
    if request.method == 'POST':
        ...
        prediction = b.predict([[Credit_History, Male, Semiurban, Urban, Married_yes, Not_Graduate,
                               Self_Employed_yes, dependent_1, dependent_2, dependent_3, LoanAmountlog, Total_incomelog]])
